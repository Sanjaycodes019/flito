...
const SERVER_MESSAGES_NE = {
  ...
  AUTH_INVALID_PIN: () => 'फोन नम्बर वा PIN मिलेन',
  AUTH_PIN_LOCKED: ({ minutes, askOwner }) => `धेरै पटक गलत PIN हालियो। ${minutes} मिनेटपछि फेरि प्रयास गर्नुहोस्, वा ${askOwner ? 'ट्रक मालिक' : 'FLITO सहायता'}सँग नयाँ PIN माग्नुहोस्।`,
  VALIDATION_PIN_FORMAT: () => 'PIN ४ अंकको हुनुपर्छ',
  VALIDATION_PIN_TOO_EASY: () => 'यो PIN अनुमान गर्न धेरै सजिलो छ। अर्को छान्नुहोस्।',
  USERS_PIN_NEEDS_PHONE: () => 'पहिले फोन नम्बर थप्नुहोस्। तपाईं नम्बर र PIN बाट लग इन गर्नुहुन्छ।',
  USERS_WRONG_CURRENT_PIN: () => 'अहिलेको PIN मिलेन',
  ADMIN_PIN_NEEDS_PHONE: () => 'यो प्रयोगकर्ताको लग इन गर्ने फोन नम्बर छैन',
  ADMIN_PIN_NOT_FOR_ADMINS: () => 'एडमिनहरू इमेल र पासवर्डबाट मात्र लग इन गर्छन्',
  VALIDATION_PIN_LOGIN_REQUIRED: () => 'फोन नम्बर र ४ अंकको PIN चाहिन्छ',
  VALIDATION_DRIVER_NAME: () => 'चालकको नाम लेख्नुहोस्',
  VALIDATION_DRIVER_PHONE: () => 'सही फोन नम्बर लेख्नुहोस्',
  DRIVERS_ALREADY_REGISTERED: () => 'यो चालकको FLITO खाता पहिले नै छ। बुकिङमा उहाँको फोन नम्बरबाट तोक्नुहोस्।',
  DRIVERS_NOT_FOUND: () => 'चालक फेला परेन',
  DRIVERS_LICENSE_LOCKED: () => 'लाइसेन्स जाँच हुँदै गर्दा वा स्वीकृत भएपछि बदल्न मिल्दैन',
